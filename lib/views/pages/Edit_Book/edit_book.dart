...
//     illustrators.text = widget.book[0].size;
...
//     EAN.text = widget.book[0].priceOfSupplier.toString();
//     ISSN.text = widget.book[0].ownBookID.toString();
//     numberOfPages.text = widget.book[0].numberOfPages.toString();
//     height.text = widget.book[0].supplierBookID.toString();
//     width.text = widget.book[0].supplier.toString();
//     weight.text = widget.book[0].weight.toString();
//     length.text = widget.book[0].supplierDeliveryTime.toString();
...
//     briefAnnotation.text = widget.book[0].coverFileUrl.toString();
//     longAnnotation.text = widget.book[0].annotation.toString();
//   }
